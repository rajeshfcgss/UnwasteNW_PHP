                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="contact-one__form-input-box">
                                            <input type="text" placeholder="Your name" name="name" style="text-align:center;">
                                        </div>
                                    </div>
                                   
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="contact-one__form-input-box">
                                            <input type="text" placeholder="Phone number" name="phone" style="text-align:center;">
                                        </div>
                                    </div>
                                   <div class="col-xl-12">
                                                            
                                        <div class="request-a-pickup__tab-content-btn-box" style="text-align:center;">
                                          <a href="register1.php" class="thm-btn request-a-pickup__tab-content-btn">Get OTP </a>
                                        </div>
                                    </div>
                                </div>
                            </form>
